...
class SeedSceneThree extends Scene {
    constructor() {
        ...
        loader.load(PixelFont, function (font) {
            const textGeometry2 = new TextGeometry("Lvl 3: Use arrow keys to move and space to interact with Eisguber", {
                font: font,
                size: 0.3,
                height: 0,
            });
            Scenes.scenes['SeedSceneThree'].textMesh = new Mesh(textGeometry2, new MeshPhongMaterial({color: 0xffffff}));
            ...
            Scenes.scenes['SeedSceneThree'].textMesh.position.set(-9.5, -6.5, 0);
...
// ----- SOUND PT 2 ----- //
    ...
    dialogue(player, grub){
        ...
        this.textMesh;
        loader.load(PixelFont, function (font) {
            const textGeometry = new TextGeometry('What is the train of Princeton?', {
                font: font,
                size: 0.3,
                height: 0,
            });
            ...
            Scenes.scenes['SeedSceneThree'].textMesh.position.set(window.innerWidth / -150, window.innerHeight / -150, player_pos.z + 2);
